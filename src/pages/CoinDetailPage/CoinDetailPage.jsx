...
const CoinDetailPage = () => {
    ...
    let [priceChange, setPriceChange] = useState(((coin.market_data) && coin.market_data.price_change_percentage_24h_in_currency.usd));
